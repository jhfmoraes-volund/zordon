import type { EvalScenario, ScenarioResult, ToolCallExpectation } from "./types";
...
/**
 * Rule-based judge — evaluates a run against a scenario's expectations.
 * Mirrors src/eval/vitor/judge.ts. judgeRubric is NOT evaluated here —
 * that's a downstream LLM judge step (intentionally out of v1).
 */
export function judgeRun(
  scenario: EvalScenario,
  output: RunOutput,
): Pick<ScenarioResult, "status" | "failures" | "reason"> {
