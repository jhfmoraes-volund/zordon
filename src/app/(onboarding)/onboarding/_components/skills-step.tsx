...
const FEATURES = [
  "Avaliação por torres (Frontend, Backend, UX, Ops…)",
  "Subskills detalhadas, score de 0 a 100",
  "Atualiza com self-assessment + revisão de líder",
  "Vira insumo direto pro PDI da próxima etapa",
] as const;
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="space-y-3">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
          Mapa de habilidade vivo.
        </h1>
        <p className="text-base leading-relaxed text-muted-foreground">
          Cada pessoa tem um scorecard por torre — onde tá forte, onde precisa
          crescer. Sem achismo, com base num modelo claro de subskills.
        </p>
      </div>
