...
export const INCEPTION_STEPS: StepDef[] = [
  ...
  { index: 5, key: "prioritization", title: "Priorizacao & Escopo", description: "MVP / Next / Out — o que entra agora?" },
  { index: 6, key: "technical_specs", title: "Especificacoes Tecnicas", description: "Stack, integracoes, regras tecnicas e restricoes" },
  { index: 7, key: "hypotheses", title: "Hipoteses & Metricas", description: "O que precisamos validar? Indicadores, metas e evidencias" },
  { index: 8, key: "briefing", title: "Briefing", description: "Resumo consolidado + geracao de tasks" },
];
