...
export type WeeklyMeeting = Tables["WeeklyMeeting"]["Row"];
export type MeetingProjectReview = Tables["MeetingProjectReview"]["Row"];
export type MeetingActionItem = Tables["MeetingActionItem"]["Row"];
...
export type WeeklyMeetingInsert = Tables["WeeklyMeeting"]["Insert"];
