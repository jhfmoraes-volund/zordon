...
| 1.5b | Calibração 8 cenários × 3 runs (24 invocações) — [docs/alpha-calibration-fase1.md](alpha-calibration-fase1.md) |
...
[docs/alpha-audit-contrato.md](alpha-audit-contrato.md) — investigou se Alpha entende o vocabulário "contrato" usado na UI Volund (`/members/[id]` chama `ProjectMember.fpAllocation` de "contrato").
...
Rodar contra **mesma régua dos cenários C1, C2, C3** da [auditoria de contrato](alpha-audit-contrato.md):
...
3. Recalibrar C1/C2/C3 — 3 runs cada, registrar em [docs/alpha-audit-contrato.md](alpha-audit-contrato.md) (~30 min)
