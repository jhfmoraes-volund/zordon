...
> **Pra um agente Claude com contexto zerado retomar/evoluir a calibragem do Vitor.** Este documento é auto-contido. Diferente de [alpha-calibration-plan.md](../alpha/alpha-calibration-plan.md) (começar do zero), aqui o Vitor já está calibrado em produção — o objetivo é **manter, evoluir e descobrir gaps novos**.
...
Caso esteja comparando com [alpha-calibration-plan.md](../alpha/alpha-calibration-plan.md):
...
**Pareceiro de runbook:** [docs/alpha-calibration-plan.md](../alpha/alpha-calibration-plan.md)
