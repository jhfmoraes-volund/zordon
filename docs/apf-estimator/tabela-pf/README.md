...
Plano canônico: [../../apf-estimator-plan-v3.md](../../features/estimation/apf-estimator-plan-v3.md) §"Fase B".
...
3. **Se não há análogo claro** → estima DET (campos do payload) e AR/TR (tabelas/arquivos referenciados) a partir dos sinais técnicos no catálogo, aplica [matriz IFPUG](../../features/estimation/function-points-reference.md). `Observação = "matriz IFPUG → tipo complexidade"`.
