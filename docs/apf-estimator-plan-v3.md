...
> Versão derivada do [V2](./apf-estimator-plan-v2.md). **V2 não está descontinuado** — V3 adiciona uma fase humana-legível antes da estimativa em PF, em vez de ir direto código → PF.
>
