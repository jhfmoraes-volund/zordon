...
**Pré-requisitos:**
- Fases 1-4 do [story-hierarchy-migration.md](../../archive/story-hierarchy-migration.md) executadas (schema + DAL + API).
...
- [story-hierarchy-migration.md](../../archive/story-hierarchy-migration.md) — plano principal de migração
- [story-hierarchy-backfill.md](../../archive/story-hierarchy-backfill.md) — backfill de projetos legados
- [alpha-calibration-plan.md](../../agents/alpha/alpha-calibration-plan.md) — calibração geral do Alpha
