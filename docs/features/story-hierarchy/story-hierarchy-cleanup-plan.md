...
- [story-hierarchy-execution-runbook.md](../../archive/story-hierarchy-execution-runbook.md) — status global das waves
- [story-hierarchy-plan.md](./story-hierarchy-plan.md) — schema-alvo V2 (§3.12: `area` substitui `type`+`scope`)
- [story-hierarchy-migration.md](../../archive/story-hierarchy-migration.md) — migração técnica original
