...
- [story-hierarchy-plan.md](../features/story-hierarchy/story-hierarchy-plan.md) — V2 do schema-alvo
- [story-hierarchy-backfill.md](./story-hierarchy-backfill.md) — backfill de projetos antigos (escopo separado)
- [story-hierarchy-alpha-integration.md](../features/story-hierarchy/story-hierarchy-alpha-integration.md) — integração com agente Alpha (escopo separado)
...
**Alpha integration** (prompt + persistência atomic) sai num plano paralelo: [story-hierarchy-alpha-integration.md](../features/story-hierarchy/story-hierarchy-alpha-integration.md). Não bloqueia rollout — pode rodar antes ou depois da Fase 5, em qualquer ponto após Fase 4.
