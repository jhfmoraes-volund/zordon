...
>
> Referência teórica: [function-points-reference.md](../features/estimation/function-points-reference.md). V1 do plano: [apf-estimator-plan.md](./apf-estimator-plan.md).
>
...
- [ ] Matriz IFPUG (de [function-points-reference.md](../features/estimation/function-points-reference.md)).
