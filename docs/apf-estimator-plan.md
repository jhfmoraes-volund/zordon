...
>
> Referência teórica: [function-points-reference.md](./function-points-reference.md). Este documento foca **exclusivamente em como extrair PF de código**, não na teoria IFPUG.
...
#### 1.3 Score (0.5 dia)
- [ ] Matriz IFPUG hardcoded de [function-points-reference.md](./function-points-reference.md).
