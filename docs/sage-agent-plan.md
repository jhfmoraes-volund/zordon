...
**Referências:**
- [docs/agent-creation-runbook.md](agent-creation-runbook.md) — runbook geral de agentes (Vitor/Alpha estilo DB-bound; não se aplica direto a subagentes Claude Code, mas vocabulário/heurísticas conversam)
